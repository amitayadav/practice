...
case class AssignmentRepo(serialNo:Long,title:String,details:String)
...
class AssignmentDbRepo @Inject()( protected val dbConfigProvider: DatabaseConfigProvider) extends Imple with AssignmentTable
